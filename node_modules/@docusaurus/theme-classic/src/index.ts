...
import {getTranslationFiles, translateThemeConfig} from '@docusaurus/theme-classic/src/translations';
...
export {validateThemeConfig} from '@docusaurus/theme-classic/src/validateThemeConfig';

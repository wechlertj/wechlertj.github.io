...
declare module '@docusaurus/plugin-content-blog' {
  export type Options = Partial<import('@docusaurus/plugin-content-blog/src/types').UserPluginOptions>;
}
...
declare module '@theme/BlogPostPage' {
  ...
  export type FrontMatter = import('@docusaurus/plugin-content-blog/src/blogFrontMatter').BlogPostFrontMatter;
  export type Assets = import('@docusaurus/plugin-content-blog/src/types').Assets;
  ...
  export type Metadata = {
    ...
    readonly authors: import('@docusaurus/plugin-content-blog/src/types').Author[];

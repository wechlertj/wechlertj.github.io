...
var defaultGetMessage = function defaultGetMessage(icon, state) {
  switch (icon) {
    ...
    case _constants.icons.load:
      ...
      if (size) {
        return ['Click to load (', _react2.default.createElement(
          'nobr',
          { key: 'nb' },
...
var IdealImage = function (_Component) {
  ...
  function IdealImage(props) {
    ...
    var _this = _possibleConstructorReturn(this, (IdealImage.__proto__ || Object.getPrototypeOf(IdealImage)).call(this, props));
    ...
    _this.load = function (userTriggered) {
      ...
      if (threshold) {
        ...
        timeoutLoader.then(function () {
          ...
          _this.setState({ overThreshold: true });
    ...
    _this.onEnter = function () {
      ...
      _this.setState({ inViewport: true });
      var pickedSrc = (0, _helpers.selectSrc)({
        srcSet: _this.props.srcSet,
        maxImageWidth: _this.props.srcSet.length > 1 ? (0, _helpers.guessMaxImageWidth)(_this.state.dimensions) : 0,
        supportsWebp: _helpers.supportsWebp
      });
      var getUrl = _this.props.getUrl;

      var url = getUrl ? getUrl(pickedSrc) : pickedSrc.src;
      var shouldAutoDownload = _this.props.shouldAutoDownload(_extends({}, _this.state, {
        size: pickedSrc.size
      }));
      _this.setState({ pickedSrc: pickedSrc, shouldAutoDownload: shouldAutoDownload, url: url });
      if (shouldAutoDownload) _this.load(false);
    };

    _this.onLeave = function () {
      if (_this.state.loadState === loading && !_this.state.userTriggered) {
        _this.setState({ inViewport: false });
        _this.cancel(false);
      }
    };
  ...
  _createClass(IdealImage, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Media2.default, _extends({}, this.props, (0, _helpers.fallbackParams)(this.props), {
          onClick: this.onClick,
          icon: icon,
          src: this.state.url || '',
          onDimensions: function onDimensions(dimensions) {
            return _this3.setState({ dimensions: dimensions });
          },
          message: message
        }))
      );
...
IdealImage.propTypes = {
  ...
  /** array of sources */
  srcSet: _propTypes2.default.arrayOf(_propTypes2.default.shape({
    width: _propTypes2.default.number.isRequired,
    src: _propTypes2.default.string,
    size: _propTypes2.default.number,
    format: _propTypes2.default.oneOf(['jpeg', 'webp'])
  })).isRequired,
  /** function which decides if image should be downloaded */
  shouldAutoDownload: _propTypes2.default.func,
  ...
  /** type of loader */
  loader: _propTypes2.default.oneOf(['image', 'xhr']),
